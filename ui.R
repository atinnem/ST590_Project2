                                ...
                                fluidRow(
                                  ...
                                  column(9,
                                         tabBox(
                                           ...
                                           tabPanel("Analysis", 
                                                    h4("Let's make some predictions! Select the time frame and variables you would like to analyze. Class, Contrast Usage, Staff ID, and Portable variables can all be used to specify your prediction."),
                                                    ...
                                                    selectizeInput("n_trees", "Number of Trees", selected = 1000, choices = seq(100,10000, by = 1000)),
                                                    uiOutput("text23"),
                                                    uiOutput("text24"),
                                                    br(),
                                                    br(),
